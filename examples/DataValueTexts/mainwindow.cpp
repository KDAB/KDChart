...
void MainWindow::populateWidgets()
{
    ...
    posPosCombo->setCurrentIndex(posPosCombo->findText(positionToScreenName(posPos.referencePosition())));
    posAlignCombo->setCurrentIndex(posAlignCombo->findText(alignmentToScreenName(posPos.alignment())));
    ...
    negPosCombo->setCurrentIndex(negPosCombo->findText(positionToScreenName(negPos.referencePosition())));
    negAlignCombo->setCurrentIndex(negAlignCombo->findText(alignmentToScreenName(negPos.alignment())));
