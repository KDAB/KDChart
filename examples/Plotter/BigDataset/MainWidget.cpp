    ...
    : m_controlsContainer(new QWidget(this))
{
    ...
    KDChart::CartesianCoordinatePlane *cPlane = qobject_cast<KDChart::CartesianCoordinatePlane *>(chart->coordinatePlane());
    Q_ASSERT(cPlane);
    ...
    m_functionSelector << m_controls.sineRadio << m_controls.triangleRadio << m_controls.squareRadio << m_controls.noiseRadio << m_controls.oneDivSineRadio
    ...
    connect(m_controls.runButton, SIGNAL(toggled(bool)), &m_model, SLOT(setRunning(bool)));
