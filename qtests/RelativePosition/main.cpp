...
private slots:
    ...
    void testRelativePositionHRelativeVAbsolute()
    {
        ...
        KDChart::Measure mHoriz(horizPerMille, KDChartEnums::MeasureCalculationModeRelative, KDChartEnums::MeasureOrientationHorizontal);
        mHoriz.setReferenceArea(m_window);

        const qreal vertAbsolute = -50.0;
        KDChart::Measure mVert(vertAbsolute, KDChartEnums::MeasureCalculationModeAbsolute);
    ...
    void testRelativePositionHAbsoluteVRelative()
    {
        ...
        KDChart::Measure mHoriz(horizAbsolute, KDChartEnums::MeasureCalculationModeAbsolute);

        const qreal vertRelative = -50.0;
        KDChart::Measure mVert(vertRelative, KDChartEnums::MeasureCalculationModeRelative, KDChartEnums::MeasureOrientationVertical);
