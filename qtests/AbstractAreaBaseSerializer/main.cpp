...
class TestKDChartAbstractAreaBaseSerializer : public QObject {
  Q_OBJECT
private slots:
    ...
    void testTextAttributes()
    {
        ...
        QDomElement savedElement =
                mDoc.createElement( "kdchart:serializer-test:AbstractAreaBase" );
...
QTEST_MAIN(TestKDChartAbstractAreaBaseSerializer)
