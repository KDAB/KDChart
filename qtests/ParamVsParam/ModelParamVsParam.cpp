...
ModelParamVsParam::ModelParamVsParam(QObject *p_parent)
...
void ModelParamVsParam::setTimeout(int p_timeout)
{
...
void ModelParamVsParam::populate(int p_nrOfParameters, int p_nrOfSamples)
{
    m_timer.stop();
