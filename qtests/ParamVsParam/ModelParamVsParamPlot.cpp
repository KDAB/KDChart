...
ModelParamVsParamPlot::ModelParamVsParamPlot(QAbstractItemModel *p_sourceModel, int p_column1, int p_column2, QObject *p_parent)
...
int ModelParamVsParamPlot::columnCount(const QModelIndex & /*p_parent*/) const
{
    return 2;
} // ModelParamVsParamPlot::columnCount()

QVariant ModelParamVsParamPlot::data(const QModelIndex &p_index, int p_role) const
{
    QVariant ret;
...
bool ModelParamVsParamPlot::filterAcceptsColumn(int p_source_column, const QModelIndex & /*p_source_parent*/) const
{
