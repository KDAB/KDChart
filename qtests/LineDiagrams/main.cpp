...
private slots:
    ...
    void testLineAttributesLevelSettings()
    {
        ...
        m_lines->setLineAttributes(la);
        QVERIFY(m_lines->lineAttributes().missingValuesPolicy() == LineAttributes::MissingValuesAreBridged);
        QVERIFY(m_lines->lineAttributes(cols - 2).missingValuesPolicy() == LineAttributes::MissingValuesHideSegments);
    ...
    void testLineAttributesValueSettings()
    {
        ...
        m_lines->setLineAttributes(la);
        // get new values
        QVERIFY(m_lines->lineAttributes().missingValuesPolicy() == LineAttributes::MissingValuesShownAsZero);
    ...
    void testThreeDLineAttributesLevelSettings()
    {
        ...
        QVERIFY(m_lines->threeDLineAttributes() != m_lines->threeDLineAttributes(cols - 2));
        QVERIFY(m_lines->threeDLineAttributes() != m_lines->threeDLineAttributes(idx));
        QVERIFY(m_lines->threeDLineAttributes(cols - 2) != m_lines->threeDLineAttributes(idx));
