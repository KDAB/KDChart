...
class TestKDChartCoordPlanesSerializer : public QObject {
  Q_OBJECT
private slots:
    ...
    void testTextAttributes()
    {
        ...
        QDomElement savedElement =
                mDoc.createElement( "kdchart:serializer-test:CoordPlanes" );
...
QTEST_MAIN(TestKDChartCoordPlanesSerializer)
