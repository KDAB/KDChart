...
void TestCartesianPlanes::doTestRangeSettings(AbstractCartesianDiagram *diagram, const QPointF &min, const QPointF &max)
{
    ...
    {
        QPair<qreal, qreal> hboundaries(diagram->dataBoundaries().first.x(), diagram->dataBoundaries().second.x());
        QPair<qreal, qreal> vboundaries(int(diagram->dataBoundaries().first.y() + 0.5), int(diagram->dataBoundaries().second.y() + 0.5));
...
void TestCartesianPlanes::testRangeSettingsPlotter()
{
    ...
    points << QPointF(0.0, 40.0) << QPointF(1.0, 45.0) << QPointF(2.0, 42.0) << QPointF(3.0, 34.0) << QPointF(4.0, 34.0);
