...
private slots:
    ...
    void testThreeDBarAttributesLevelSettings()
    {
        ...
        QVERIFY(m_bars->threeDBarAttributes() != m_bars->threeDBarAttributes(cols - 2));
        QVERIFY(m_bars->threeDBarAttributes() != m_bars->threeDBarAttributes(idx));
        QVERIFY(m_bars->threeDBarAttributes(cols - 2) != m_bars->threeDBarAttributes(idx));
