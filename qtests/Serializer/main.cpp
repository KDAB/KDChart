...
#include <KDChartSerializerSerializer>

using namespace KDChart;

class TestKDChartSerializer : public QObject {
  Q_OBJECT
private slots:
    ...
    void testKDChartSerializerTestTextAttributes()
    {
        ...
        QDomElement savedElement =
                mDoc.createElement( "kdchart:serializer-test:Serializer" );
...
QTEST_MAIN(TestKDChartSerializer)
