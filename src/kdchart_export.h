...
#  endif
#  ifdef KDCHART_BUILD_KDCHART_PLUGIN_LIB
#   define KDCHART_PLUGINS_EXPORT Q_DECL_EXPORT
#   define KDCHART_PLUGINS_PLUGIN_EXPORT Q_DECL_EXPORT
#  else
#   define KDCHART_PLUGINS_EXPORT Q_DECL_IMPORT
#   define KDCHART_PLUGINS_PLUGIN_EXPORT Q_DECL_IMPORT
#  endif
# else
#  define KDCHART_EXPORT Q_DECL_IMPORT
#  define KDCHART_COMPAT_EXPORT Q_DECL_IMPORT
