...
public:
    ...
    void setAutoReferenceArea(const QObject *area);
    [[nodiscard]] const QObject *autoReferenceArea() const;
...
public:
    ...
    static void
    paintIntoRect(QPainter *painter, const QRect &rect, AbstractDiagram *diagram, const MarkerAttributes &marker, const QBrush &brush, const QPen &pen);
...
public:
    ...
    [[nodiscard]] virtual Qt::Alignment legendLineSymbolAlignment() const;
