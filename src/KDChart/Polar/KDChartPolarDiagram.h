...
public:
    explicit PolarDiagram(QWidget *parent = 0, PolarCoordinatePlane *plane = 0);
...
public:
    ...
    virtual void paint(PaintContext *paintContext, bool calculateListAndReturnScale, qreal &newZoomX, qreal &newZoomY); // KDChart 3: references -> pointers
