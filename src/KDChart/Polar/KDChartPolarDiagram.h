...
public:
    ...
    [[nodiscard]] virtual PolarDiagram *clone() const;
    ...
    [[nodiscard]] int zeroDegreePosition() const;

    void setRotateCircularLabels(bool rotateCircularLabels);
    [[nodiscard]] bool rotateCircularLabels() const;
    ...
    [[nodiscard]] bool showDelimitersAtPosition(Position position) const;

    [[nodiscard]] bool showLabelsAtPosition(Position position) const;

    virtual void paint(PaintContext *paintContext, bool calculateListAndReturnScale, qreal &newZoomX,
                       qreal &newZoomY); // KDChart 3: references -> pointers
