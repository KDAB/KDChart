...
{
    return d->attributesModel->data(d->attributesModel->mapFromSource(index), KDChart::LineAttributesRole).value<LineAttributes>();
}
...
{
    return d->attributesModel->data(d->attributesModel->mapFromSource(index), KDChart::ThreeDLineAttributesRole).value<ThreeDLineAttributes>();
}
...
{
    return d->attributesModel->data(d->attributesModel->mapFromSource(index), KDChart::ValueTrackerAttributesRole).value<ValueTrackerAttributes>();
}
