...
void AbstractCartesianDiagram::init()
{
    ...
    connect(this, SIGNAL(layoutChanged(AbstractDiagram *)), &d->compressor, SLOT(slotDiagramLayoutChanged(AbstractDiagram *)));
...
{
    if (coordinatePlane()) {
        disconnect(attributesModel(), SIGNAL(rowsRemoved(const QModelIndex &, int, int)), coordinatePlane(), SLOT(relayout()));
        disconnect(attributesModel(), SIGNAL(rowsInserted(const QModelIndex &, int, int)), coordinatePlane(), SLOT(relayout()));
        disconnect(attributesModel(), SIGNAL(columnsRemoved(const QModelIndex &, int, int)), coordinatePlane(), SLOT(relayout()));
        disconnect(attributesModel(), SIGNAL(columnsInserted(const QModelIndex &, int, int)), coordinatePlane(), SLOT(relayout()));
    ...
    if (plane) {
        ...
        connect(attributesModel(), SIGNAL(rowsRemoved(const QModelIndex &, int, int)), plane, SLOT(relayout()));
        connect(attributesModel(), SIGNAL(rowsInserted(const QModelIndex &, int, int)), plane, SLOT(relayout()));
        connect(attributesModel(), SIGNAL(columnsRemoved(const QModelIndex &, int, int)), plane, SLOT(relayout()));
        connect(attributesModel(), SIGNAL(columnsInserted(const QModelIndex &, int, int)), plane, SLOT(relayout()));
