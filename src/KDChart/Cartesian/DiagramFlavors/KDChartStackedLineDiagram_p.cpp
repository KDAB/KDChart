    ...
    for (int column = 0; column < columnCount; ++column) {
        ...
        for (int row = 0; row < rowCount; ++row) {
            ...
            if (row + 1 < rowCount) {
                ...
                ptSouthEast = bDisplayCellArea ? dataAt(stackedValuesBottom, nextKey, 2) : ptNorthEast;
                ...
                if (bDisplayCellArea) {
                    ...
                    const QPointF ptAfterNorthEast = row < rowCount - 2 ? dataAt(stackedValuesTop, point.key + 2, 3) : ptNorthEast;
                    ...
                    const QPointF ptAfterSouthEast = row < rowCount - 2 ? dataAt(stackedValuesBottom, point.key + 2, 3) : ptSouthEast;
