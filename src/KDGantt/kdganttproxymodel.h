...
public:
    ...
    [[nodiscard]] int column(int ganttrole) const;
    [[nodiscard]] int role(int ganttrole) const;
    ...
    /*reimp*/ [[nodiscard]] QModelIndex mapFromSource(const QModelIndex &idx) const override;
    /*reimp*/ [[nodiscard]] QModelIndex mapToSource(const QModelIndex &proxyIdx) const override;
