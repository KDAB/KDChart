...
public:
    ...
    [[nodiscard]] QBrush defaultBrush(ItemType type) const;

    void setDefaultPen(ItemType type, const QPen &pen);
    [[nodiscard]] QPen defaultPen(ItemType type) const;

    [[nodiscard]] virtual Span itemBoundingSpan(const StyleOptionGanttItem &opt, const QModelIndex &idx) const;
    [[nodiscard]] virtual QRectF constraintBoundingRect(const QPointF &start, const QPointF &end, const Constraint &constraint) const;
    [[nodiscard]] virtual InteractionState interactionStateFor(const QPointF &pos, const StyleOptionGanttItem &opt, const QModelIndex &idx) const;
    ...
    [[nodiscard]] virtual QString toolTip(const QModelIndex &idx) const;
...
protected:
    ...
    [[nodiscard]] QPolygonF finishStartLine(const QPointF &start, const QPointF &end) const;
    [[nodiscard]] QPolygonF finishStartArrow(const QPointF &start, const QPointF &end) const;
    ...
    [[nodiscard]] QPolygonF finishFinishLine(const QPointF &start, const QPointF &end) const;
    [[nodiscard]] QPolygonF finishFinishArrow(const QPointF &start, const QPointF &end) const;
    ...
    [[nodiscard]] QPolygonF startStartLine(const QPointF &start, const QPointF &end) const;
    [[nodiscard]] QPolygonF startStartArrow(const QPointF &start, const QPointF &end) const;
    ...
    [[nodiscard]] QPolygonF startFinishLine(const QPointF &start, const QPointF &end) const;
    [[nodiscard]] QPolygonF startFinishArrow(const QPointF &start, const QPointF &end) const;
};
}
