...
void ConstraintProxy::setSourceModel(ConstraintModel *src)
{
    ...
    connect(m_source, SIGNAL(constraintAdded(const KDGantt::Constraint &)), this, SLOT(slotSourceConstraintAdded(const KDGantt::Constraint &)));
    connect(m_source, SIGNAL(constraintRemoved(const KDGantt::Constraint &)), this, SLOT(slotSourceConstraintRemoved(const KDGantt::Constraint &)));
}
...
void ConstraintProxy::setDestinationModel(ConstraintModel *dest)
{
    ...
    connect(m_destination, SIGNAL(constraintAdded(const KDGantt::Constraint &)), this, SLOT(slotDestinationConstraintAdded(const KDGantt::Constraint &)));
    connect(m_destination, SIGNAL(constraintRemoved(const KDGantt::Constraint &)), this, SLOT(slotDestinationConstraintRemoved(const KDGantt::Constraint &)));
}
