...
{
    switch (range) {
    case KDGantt::DateTimeScaleFormatter::Second:
        dbg << "KDGantt::DateTimeScaleFormatter::Second";
        break;
    case KDGantt::DateTimeScaleFormatter::Minute:
        dbg << "KDGantt::DateTimeScaleFormatter::Minute";
        break;
    case KDGantt::DateTimeScaleFormatter::Hour:
        dbg << "KDGantt::DateTimeScaleFormatter::Hour";
        break;
    case KDGantt::DateTimeScaleFormatter::Day:
        dbg << "KDGantt::DateTimeScaleFormatter::Day";
        break;
    case KDGantt::DateTimeScaleFormatter::Week:
        dbg << "KDGantt::DateTimeScaleFormatter::Week";
        break;
    case KDGantt::DateTimeScaleFormatter::Month:
        dbg << "KDGantt::DateTimeScaleFormatter::Month";
        break;
    case KDGantt::DateTimeScaleFormatter::Year:
        dbg << "KDGantt::DateTimeScaleFormatter::Year";
        break;
    }
    return dbg;
}
...
Span DateTimeGrid::mapToChart(const QModelIndex &idx) const
{
    ...
    if (sv.canConvert(QVariant::DateTime) && ev.canConvert(QVariant::DateTime) && !(sv.type() == QVariant::String && sv.toString().isEmpty()) && !(ev.type() == QVariant::String && ev.toString().isEmpty())) {
    ...
    public:
        ...
        QRect textRect(qreal x, qreal offset, qreal dayWidth, const QRectF &headerRect, const QDateTime &dt) override
        {
            ...
            return QRectF(QPointF(x, headerRect.top()) + QPointF(-offset + 1.0, headerRect.height() / 2.0),
                          QSizeF(dayWidth / 24.0, headerRect.height() / 2.0))
                .toAlignedRect();
        }
    };
                                       ...
                                       qreal offset, QWidget *widget)
{
    ...
    public:
        ...
        QRect textRect(qreal x, qreal offset, qreal dayWidth, const QRectF &headerRect, const QDateTime &dt) override
        {
            ...
            return QRectF(QPointF(x, headerRect.top()) + QPointF(-offset, 0.0),
                          QSizeF(dayWidth * 7, headerRect.height() / 2.0))
                .toRect();
        }
    };
    d->paintHeader(painter, headerRect, exposedRect, offset, widget, // General parameters
                                         ...
                                         qreal offset, QWidget *widget)
{
    ...
    public:
        ...
        {
            return QRectF(QPointF(x, headerRect.top()) + QPointF(-offset, 0.0),
                          QSizeF(dayWidth * dt.date().daysInYear(), headerRect.height() / 2.0))
                .toRect();
        }
    };
    d->paintHeader(painter, headerRect, exposedRect, offset, widget, // General parameters
