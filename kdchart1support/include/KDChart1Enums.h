 ...
 **
 **********************************************************************/
#ifndef __KDCHART1ENUMS_H__
#define __KDCHART1ENUMS_H__
...
/** \file KDChart1Enums.h
  \brief Definition of global enums.
  */

/**
  Project global class providing some enums needed both by KDChart1Params
  and by KDChart1CustomBox.
  */
class KDCHART1_EXPORT KDChart1Enums :public QObject
{
    Q_OBJECT
    ...
    public:
        /**
          ...
          \sa KDChart1Params::setPrintDataValues
          */
        enum TextLayoutPolicy { LayoutJustOverwrite,
            ...
            /**
              ...
              KDChart1CustomBox where you have the parameters \c dataRow, \c dataCol, \c data3rd.
              ...
              \sa KDChart1Params::setSimpleFrame, KDChart1Params::setFrame
              \sa KDChart1Params::insertCustomBox, KDChart1CustomBox
              */
...
*/
                enum PositionFlag { PosTopLeft   =0, PosTopCenter   =1, PosTopRight   =2,
                    ...
                    /**
                      ...
                      */
                    static QPoint positionFlagToPoint( const QPolygon& points,
                            PositionFlag pos )
                    {
                        QPoint pt;
                        if( 9 <= points.size() )
