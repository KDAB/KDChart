 ...
 **
 **********************************************************************/
#ifndef __KDCHART1PROPERTYSET__
#define __KDCHART1PROPERTYSET__
...
/**
  \file KDChart1PropertySet.h

  \brief Property settings of a single KDChart1 data cell.
  */

/**
  \class KDChart1PropertySet KDChart1PropertySet.h
  \brief Property settings of a single KDChart1 data cell.

  \note The property settings feature currently is supported by
  normal (== not 3-dimensional!) Line Charts only. Future releases
  of KDChart1 will offer a rich set of options to use cell-specific
  properties for other chart types as well...

  The KDChart1PropertySet class stores several settings to be
  ...
  value for it or by using the ID of another KDChart1PropertySet
...
\sa KDChart1Params::registerProperties
*/
class KDCHART1_EXPORT KDChart1PropertySet :public QObject
{
    Q_OBJECT
    ...
    /**
      ...
      e.g. you might pass KDCHART1_PROPSET_NORMAL_DATA
      ...
      */
    KDChart1PropertySet( const QString& name, int idParent=KDChart1PropertySet::UndefinedID ) :
        mOwnID( UndefinedID )
    ...
    /**
      ...
      */
    void deepCopy( const KDChart1PropertySet* source );
    ...
    /**
      ...
      */
    KDChart1PropertySet* clone() const;
    ...
    /**
      ...
      \sa clone, fullReset
      */
    void quickReset( const QString& name, int idParent=KDChart1PropertySet::UndefinedID );
    ...
    /**
      ...
      \sa clone, quickReset
      */
    void fullReset( const QString& name, int idParent=KDChart1PropertySet::UndefinedID );
    ...
    /**
      ...
      make sure to call KDChart1Params::setProperties( set.id(), set )
      after calling \c load() if you want to use the loaded
      property set in the context of KDChart1Param settings.

      \returns TRUE if the property set could be read.

      \sa id, saveXLM
      */
    static bool loadXML( const QDomElement& element, KDChart1PropertySet& set );
...
public slots:
    ...
    /**
      ...
      Use special value KDChart1PropertySet::UndefinedID
      to specify neither another property set's ID
      nor an own value for this flag.
      Use special value KDChart1PropertySet::OwnID
      ...
      is not set to KDChart1PropertySet::OwnID.
    ...
    /**
      ...
      are to be used: in this case idShowBar will be KDChart1Params::NormalData

      \param idShowBar to be ignored if return value is TRUE.
      If idShowBar is KDChart1PropertySet::UndefinedID
      ...
      value KDChart1PropertySet::UndefinedID as decribed above.
    ...
    /**
      ...
      \note The return value will also be FALSE if the 'default' properties
      are to be used: in this case idBarColor will be KDChart1Params::NormalData

      \param idBarColor to be ignored if return value is TRUE.
      If idBarColor is KDChart1PropertySet::UndefinedID
      then neither a property set ID
    ...
    /**
      ...
      If idLineWidth is KDChart1PropertySet::UndefinedID
      then neither a property set ID
    ...
    /**
      ...
      \note The return value will also be FALSE if the 'default' properties
      are to be used: in this case idLineColor will be KDChart1Params::NormalData

      \param idLineColor to be ignored if return value is TRUE.
      If idLineColor is KDChart1PropertySet::UndefinedID
      then neither a property set ID
    ...
    /**
      ...
      \note The return value will also be FALSE if the 'default' properties
      are to be used: in this case idLineStyle will be KDChart1Params::NormalData

      \param idLineStyle to be ignored if return value is TRUE.
      If idLineStyle is KDChart1PropertySet::UndefinedID
      then neither a property set ID
    ...
    /**
      ...
      \note The return value will also be FALSE if the 'default' properties
      are to be used: in this case idAreaBrush will be KDChart1Params::NormalData

      \param idAreaBrush to be ignored if return value is TRUE.
      If idAreaBrush is KDChart1PropertySet::UndefinedID
      then neither a property set ID
    ...
    /**
      ...
      \note The return value will also be FALSE if the 'default' properties
      are to be used: in this case idShowMarker will be KDChart1Params::NormalData

      \param idShowMarker to be ignored if return value is TRUE.
      If idShowMarker is KDChart1PropertySet::UndefinedID
      then neither a property set ID
      nor an own flag were specified (so no special
...
protected:
    // the following member only to be set internally by KDChart1Params::registerProperties
    // and by KDChart1Params::setProperties
    int mOwnID;

private:
    KDChart1PropertySet( const KDChart1PropertySet& ) : QObject(0) {}
