 ...
 **
 **********************************************************************/
#ifndef __KDCHART1DATAINTERN_H__
#define __KDCHART1DATAINTERN_H__
...
// It's necessary since it's part of the interface provided by KDChart1
class KDCHART1_EXPORT KDChart1Data
{
public:
    ...
    KDChart1Data( double yValue, QDateTime xValue ) :
    ...
    KDChart1Data( const QVariant& _value1,
    ...
    /* date/time values for /ordinate/ axes are not implemented yet
       KDChart1Data( QDateTime yValue, QDateTime xValue ) :
    ...
    KDChart1Data( double yValue, double xValue ) :
        _valueType(  QVariant::Double ), dValue(  yValue  ),
        _valueType2( QVariant::Double ), dValue2( xValue ),
        _propSetID(  0 )
    {}
    /* date/time values for /ordinate/ axes are not implemented yet
       KDChart1Data( QDateTime yValue, double xValue ) :
       _valueType(  DateTime ), dtValue( yValue  ),
...
/*
    /-**
       ...
       \sa setData
    * /
    KDChart1Data( const KDChart1Data& other ) :
    {
        setData( other );
    }
    ...
    /-**
       ...
       \sa setData
    * /
    KDChart1Data& operator=( const KDChart1Data& R )
    {
        setData( R );
        return *this;
    }
*/
    /**
       ...
       \sa isEqual
    */
    bool operator==( const KDChart1Data& it ) const
    {
    ...
    */
    ...
    /**
       ...
       Two KDChart1Data are considered equal if their data values are equal - the
       property set ID is ignored.
    */
    bool isEqual( const KDChart1Data& a, const KDChart1Data& b ) const
    {
    ...
    /**
       ...
       \sa setData
    */
    void setAll( const KDChart1Data& R )
    {
        setData( R );
    ...
    /**
       ...
       If you want to set it please call \c KDChart1Data::setPropertySet() explicitely.

       \sa setAll
    */
    void setData( const KDChart1Data& R )
    {
        if( &R != this ){
    ...
    /**
       ...
       at KDChart1PropertySet::BuiltinDataPropertySetIDs or
       a special ID that was given back by a
       KDChart1Params::registerProperties function call.
    ...
    */
    ...
    /**
       ...
       Use KDChart1Params::properties( int ID ) for accessing the respective property set information.
