 ...
 **
 **********************************************************************/
#ifndef __KDCHART1AXISPARAMS_H__
#define __KDCHART1AXISPARAMS_H__
...
/**
  ...
  \sa setAxisValues
  */
#define KDCHART1_AXIS_LABELS_AUTO_LIMIT QVariant( 140319.64 )
...
/**
  ...
  \sa setAxisValues
  */
#define KDCHART1_AXIS_LABELS_AUTO_DELTA 140319.64
...
/**
  ...
  \sa setAxisValues
  */
#define KDCHART1_AXIS_LABELS_AUTO_DIGITS 14364
...
#define KDCHART1_DEFAULT_AXIS_GRID_COLOR QColor( 0xA0, 0xA0, 0xA0 )
...
/**
  ...
  */
#define KDCHART1_AXIS_GRID_AUTO_LINEWIDTH 14364
...
/**
  ...
  \sa setAxisValues
  */
#define KDCHART1_AXIS_IGNORE_EMPTY_INNER_SPAN 1
...
#define KDCHART1_DONT_CHANGE_EMPTY_INNER_SPAN_NOW -2




/** \file KDChart1AxisParams.h
  \brief Provide access to the chart axis parameters.

  Use the KDChart1AxisParams class to modify parameters of one axis each.
  */

class KDCHART1_EXPORT KDChart1AxisParams : public QObject
{
    Q_OBJECT
    Q_ENUMS(AxisType)
    Q_ENUMS(AxisPos)
...
public slots:
    ...
    void setAxisLabelsCalc( int divPow10 = 0,
                            int digitsBehindComma = KDCHART1_AXIS_LABELS_AUTO_DIGITS );
...
public slots:
    void setAxisValues( bool axisSteadyValueCalc = true,
                        const QVariant& axisValueStart = KDCHART1_AXIS_LABELS_AUTO_LIMIT,
                        const QVariant& axisValueEnd = KDCHART1_AXIS_LABELS_AUTO_LIMIT,
                        double axisValueDelta = KDCHART1_AXIS_LABELS_AUTO_DELTA,
                        int axisDigitsBehindComma = KDCHART1_AXIS_LABELS_AUTO_DIGITS,
                        int axisMaxEmptyInnerSpan = KDCHART1_DONT_CHANGE_EMPTY_INNER_SPAN_NOW,
...
public:
    KDChart1AxisParams();
    virtual ~KDChart1AxisParams();
    KDChart1AxisParams& operator=( const KDChart1AxisParams& R );
    static void deepCopy( KDChart1AxisParams& D, const KDChart1AxisParams& R );
