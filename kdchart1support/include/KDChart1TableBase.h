 ...
 **
 **********************************************************************/
#ifndef __KDCHART1TABLEINTERFACE_H__
#define __KDCHART1TABLEINTERFACE_H__
...
/**
    ...
    If your own table class (derived from KDChart1TableDataBase) does
    not store your positive infinite values as KDCHART1_POS_INFINITE
    please make sure to reimplement \sa isPosInfinite() accordingly.

    \sa isPosInfinite, isNegInfinite
*/
#define KDCHART1_POS_INFINITE DBL_MAX

/**
    Use special value KDCHART1_NEG_INFINITE to indicate negative infinite values.

    If your own table class (derived from KDChart1TableDataBase) does
    not store your negative infinite values as KDCHART1_NEG_INFINITE
    please make sure to reimplement \sa isNegInfinite() accordingly.

    \sa isNegInfinite, isPosInfinite
*/
#define KDCHART1_NEG_INFINITE -DBL_MAX


/**
   \file KDChart1TableBase.h

   \brief Provides a table class holding all data values
   that are to be used in a chart.

   By subclassing KDChart1TableDataBase you may provide your own
...
class KDCHART1_EXPORT KDChart1TableDataBase :public QObject
{
    Q_OBJECT
public:
    /**
    ...
    /**
      ...
      */
    KDChart1TableDataBase( const KDChart1TableDataBase& other ) :QObject(0)
    {
...
public slots:
    /**
      ...
      each class derived from KDChart1TableDataBase.
...
const double xVal = data.cellVal( r, c, 2 ).toDouble(); \endverbatim
    ...
    /**
      ...
      may be reimplemented by classes derived from KDChart1TableDataBase.
    ...
    /**
      ...
      to return the appropriate value if your class derived from KDChart1TableDataBase
    ...
    */
    ...
    /**
        ...
        classes derived from KDChart1TableDataBase.
        This should be done if your data are not stored as
        special value KDCHART1_POS_INFINITE
    ...
    */
    ...
    {
        return value == KDCHART1_POS_INFINITE;
    }
    ...
    /**
        ...
        classes derived from KDChart1TableDataBase.
        This should be done if your data are not stored as
        special value KDCHART1_NEG_INFINITE
    ...
    */
    ...
    {
        return value == KDCHART1_NEG_INFINITE;
    }
