...
/**
  \fn QTextStream& operator<<( QTextStream& s, const KDChart1Params& p );

  Writes the KDChart1Params object p as an XML document to the text stream s.

  \param s the text stream to write to
  \param p the KDChart1Params object to write
  \return the text stream after the write operation
  */
QTextStream& operator<<( QTextStream& s, const KDChart1Params& p )
{
    ...
    for( int axis = 0; axis < 13; axis++ ) {
                ...
                _axisSettings[axis].chart );
        {
            ...
            KDXML::createStringNode( doc, axisSettingsElement, "Type",
                    KDChart1AxisParams::axisTypeToString( _axisSettings[axis].params._axisType ) );
            ...
            KDXML::createStringNode( doc, axisSettingsElement, "AreaMode",
                    KDChart1AxisParams::axisAreaModeToString( _axisSettings[axis].params._axisAreaMode ) );
            ...
            KDXML::createStringNode( doc, axisSettingsElement, "CalcMode",
                    KDChart1AxisParams::axisCalcModeToString( _axisSettings[axis].params._axisCalcMode ) );
            ...
            if( ! ( KDCHART1_AXIS_LABELS_AUTO_LIMIT == _axisSettings[axis].params._axisValueStart ))
            ...
            if( ! ( KDCHART1_AXIS_LABELS_AUTO_LIMIT == _axisSettings[axis].params._axisValueEnd ))
            ...
            if( ! ( KDCHART1_AXIS_LABELS_AUTO_DELTA == _axisSettings[axis].params._axisValueDelta ))
            ...
            KDXML::createStringNode( doc, axisSettingsElement, "LabelsFromDataRow",
                    KDChart1AxisParams::labelsFromDataRowToString( _axisSettings[axis].params._takeLabelsFromDataRow ) );
...
/**
  ...
  \sa loadXML
  */
QDomDocument KDChart1Params::saveXML( bool withPI ) const
{
    ...
    if( withPI )
        doc.appendChild( doc.createProcessingInstruction( "xml", "version=\"1.99\" encoding=\"UTF-8\"" ) );
    ...
    for( QMap<uint,KDChart1Params::ModeAndChart>::ConstIterator it = _dataSourceModeAndChart.begin();
        ...
        modeAndChartElement.setAttribute( "Mode", chartSourceModeToString( (*it).mode() ) );
        modeAndChartElement.setAttribute( "Chart", (*it).chart() );
    ...
    for( KDChart1PropertySetList::ConstIterator it2 = _propertySetList.begin();
         it2 != _propertySetList.end(); ++it2 )
        propertySetMapElement.appendChild( it2.value()->saveXML( doc ) );
...

    {
        ...
        KDXML::createStringNode( doc, barSettingsElement,
                "SubType", KDChart1Params::barChartSubTypeToString( _barChartSubType ) );
...

    {
        ...
        KDXML::createStringNode( doc, lineSettingsElement,
                "SubType", KDChart1Params::lineChartSubTypeToString( _lineChartSubType ) );
        ...
        {for( QMap<uint,KDChart1Params::LineMarkerStyle>::ConstIterator it = _lineMarkerStyles.begin();
            ...
            markerStyleElement.setAttribute( "Style", KDChart1Params::lineMarkerStyleToString( (*it) ) );
        }}
        ...
        {for( QMap<uint, Qt::PenStyle>::ConstIterator it = _datasetLineStyles.begin();
            ...
            lineStyleElement.setAttribute( "Style", KDXML::penStyleToString( (*it) ) );
        }}
...

    {
        ...
        KDXML::createStringNode( doc, areaSettingsElement, "SubType",
                KDChart1Params::areaChartSubTypeToString( _areaChartSubType ) );

        // the Location elemenet
        KDXML::createStringNode( doc, areaSettingsElement, "Location",
                KDChart1Params::areaLocationToString( _areaLocation ) );
    }
    ...
    docRoot.appendChild( hiLoSettingsElement );
    {
        ...
        KDXML::createStringNode( doc, hiLoSettingsElement, "SubType",
                KDChart1Params::hiLoChartSubTypeToString( _hiLoChartSubType ) );
    ...
    docRoot.appendChild( bWSettingsElement );
    {
        ...
        KDXML::createStringNode( doc, bWSettingsElement, "SubType",
                KDChart1Params::bWChartSubTypeToString( _BWChartSubType ) );
...

    {
        ...
        KDXML::createStringNode( doc, polarSettingsElement,
                "SubType", KDChart1Params::polarChartSubTypeToString( _polarChartSubType ) );
        ...
        // the MarkerStyles elements
        for( QMap<uint,KDChart1Params::PolarMarkerStyle>::ConstIterator it = _polarMarkerStyles.begin();
                it != _polarMarkerStyles.end(); ++it ) {
            QDomElement markerStyleElement = doc.createElement( "MarkerStyle" );
            polarSettingsElement.appendChild( markerStyleElement );
            markerStyleElement.setAttribute( "Dataset", it.key() );
            markerStyleElement.setAttribute( "Style", KDChart1Params::polarMarkerStyleToString( (*it) ) );
        }
    ...
    docRoot.appendChild( legendSettingsElement );
    {
        ...
        KDXML::createStringNode( doc, legendSettingsElement, "Position",
                KDChart1Params::legendPositionToString( _legendPosition ) );
        ...
        KDXML::createStringNode( doc, legendSettingsElement, "Source",
                KDChart1Params::legendSourceToString( _legendSource ) );
        ...
        for( QMap<int,QString>::ConstIterator it = _legendText.begin();
            ...
            legendTextElement.setAttribute( "Text", (*it) );
        }
    ...
    docRoot.appendChild( dataValuesSettings1Element );
    {
        ...
        KDXML::createStringNode( doc, dataValuesSettings1Element,
                ...
                KDChart1Enums::positionFlagToString( _printDataValuesSettings._dataValuesAnchorNegativePosition ) );
        ...
        KDXML::createStringNode( doc, dataValuesSettings1Element,
                ...
                KDChart1Enums::positionFlagToString( _printDataValuesSettings._dataValuesAnchorPositivePosition ) );
        KDXML::createIntNode( doc, dataValuesSettings1Element,
                "AnchorPositiveAlign",
        ...
        KDXML::createStringNode( doc, dataValuesSettings1Element,
                "LayoutPolicy",
                KDChart1Enums::layoutPolicyToString( _printDataValuesSettings._dataValuesLayoutPolicy ) );
    ...
    docRoot.appendChild( dataValuesSettings2Element );
    {
        ...
        KDXML::createStringNode( doc, dataValuesSettings2Element,
                "AnchorNegativePosition",
                KDChart1Enums::positionFlagToString( _printDataValuesSettings2._dataValuesAnchorNegativePosition ) );
        ...
        KDXML::createStringNode( doc, dataValuesSettings2Element,
                "AnchorPositivePosition",
                KDChart1Enums::positionFlagToString( _printDataValuesSettings2._dataValuesAnchorPositivePosition ) );
        KDXML::createIntNode( doc, dataValuesSettings2Element,
                "AnchorPositiveAlign",
        ...
        KDXML::createStringNode( doc, dataValuesSettings2Element,
                "LayoutPolicy",
                KDChart1Enums::layoutPolicyToString( _printDataValuesSettings2._dataValuesLayoutPolicy ) );
    ...
    docRoot.appendChild( areaMapElement );
    {
        ...
        for( ; it.current(); ++it ){
            KDChart1FrameSettings::createFrameSettingsNode( doc, areaMapElement,
                    "FrameSettings",
                    it.current(),
    ...
    {
        QIntDictIterator<KDChart1CustomBox> it( _customBoxDict );
        for( ; it.current(); ++it ){
            KDXML::createIntNode( doc, customBoxMapElement, "Number", it.currentKey() );
            KDChart1CustomBox::createCustomBoxNode( doc, customBoxMapElement,
                    "CustomBox", it );
        }
    }
...
/**
  \fn QTextStream& operator>>( QTextStream& s, KDChart1Params& p );

  Reads the an XML document from the text stream s into the
  KDChart1Params object p

  \param s the text stream to read from
  \param p the KDChart1Params object to read into
  \return the text stream after the read operation
  */
QTextStream& operator>>( QTextStream& s, KDChart1Params& p )
{
    Q_UNUSED(p);
    return s;
...
/**
  ...
  */
void KDChart1Params::loadAxesFormXML(int& curAxisSettings, QDomElement& element)
{

    Q_UNUSED(curAxisSettings);
    Q_UNUSED(element);

    return;

    /*
    KDChart1AxisParams* axisSettings =
        ...
        if( !element.isNull() ) { // was really an element
            ...
            if( tagName == "Type" ) {
                ...
                if( KDXML::readStringNode( element, string ) )
                    axisSettings->_axisType = KDChart1AxisParams::stringToAxisType( string );
                ...
                QString string;
                if( KDXML::readStringNode( element, string ) )
                    axisSettings->_axisAreaMode = KDChart1AxisParams::stringToAxisAreaMode( string );
                ...
                QString string;
                if( KDXML::readStringNode( element, string ) )
                    axisSettings->_axisCalcMode = KDChart1AxisParams::stringToAxisCalcMode( string );
                ...
                if( KDXML::readIntNode( element, valueDeltaScale ) )
                    axisSettings->_axisValueDeltaScale = (KDChart1AxisParams::ValueScale)valueDeltaScale;
                ...
                QString string;
                if( KDXML::readStringNode( element, string ) )
                    axisSettings->_labelTextsDataRow = KDChart1AxisParams::stringToLabelsFromDataRow( string );
...
/**
  ...
  \sa saveXML
  */
bool KDChart1Params::loadXML( const QDomDocument& doc )
{
        ...
        if( !element.isNull() ) { // was really an element
            ...
            if( tagName == "ChartType" ) {
                if( element.hasAttribute( "primary" ) )
                    _chartType = KDChart1Params::stringToChartType( element.attribute( "primary" ) );
                if( element.hasAttribute( "secondary" ) )
                    _additionalChartType = KDChart1Params::stringToChartType( element.attribute( "secondary" ) );
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "Dataset" ) {
                            ...
                            if( element.hasAttribute( "Mode" ) &&
                                ...
                                KDChart1Params::SourceMode sourceMode = KDChart1Params::stringToChartSourceMode( element.attribute( "Mode" ) );
                                bool ok = false;
                                uint chart = element.attribute( "Chart" ).toUInt( &ok );
                                if( ok )
                                    _dataSourceModeAndChart[dataset] = KDChart1Params::ModeAndChart( sourceMode, chart );
                            }
                        } else {
                ...
                // the PropertySetMap element
                QDomNode node = element.firstChild();
                KDChart1PropertySet set;
                while( !node.isNull() ) {
                    QDomElement element = node.toElement();
                    if(    !element.isNull() // was really an element
                            && KDChart1PropertySet::loadXML( element, set ) ) // parsed OK
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _barChartSubType = KDChart1Params::stringToBarChartSubType( value );
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _lineChartSubType = KDChart1Params::stringToLineChartSubType( value );
                            ...
                            bool ok = true;
                            uint dataset;
                            KDChart1Params::LineMarkerStyle style = LineMarkerCircle;
                            if( element.hasAttribute( "Dataset" ) &&
                                    element.hasAttribute( "Style" ) ) {
                                dataset = element.attribute( "Dataset" ).toUInt( &ok );
                                if( ok )
                                    style = KDChart1Params::stringToLineMarkerStyle( element.attribute( "Style" ) );
                            } else
                                ok = false;
                            if( ok )
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _areaChartSubType = KDChart1Params::stringToAreaChartSubType( value );
                        } else if( tagName == "Location" ) {
                            QString string;
                            if( KDXML::readStringNode( element, string ) )
                                _areaLocation = KDChart1Params::stringToAreaLocation( string );
                        } else {
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _hiLoChartSubType = KDChart1Params::stringToHiLoChartSubType( value );
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _BWChartSubType = KDChart1Params::stringToBWChartSubType( value );
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "SubType" ) {
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _polarChartSubType = KDChart1Params::stringToPolarChartSubType( value );
                        } else if( tagName == "Marker" ) {
                            bool marker;
                            if( KDXML::readBoolNode( element, marker ) )
                                _polarMarker = marker;
                            ...
                            bool ok = true;
                            uint dataset;
                            KDChart1Params::PolarMarkerStyle style = PolarMarkerCircle;
                            if( element.hasAttribute( "Dataset" ) &&
                                    element.hasAttribute( "Style" ) ) {
                                dataset = element.attribute( "Dataset" ).toUInt( &ok );
                                if( ok )
                                    style = KDChart1Params::stringToPolarMarkerStyle( element.attribute( "Style" ) );
                            } else
                                ok = false;
                            if( ok )
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "Position" ) {
                            QString string;
                            if( KDXML::readStringNode( element, string ) )
                                _legendPosition = KDChart1Params::stringToLegendPosition( string );
                            ...
                            QString string;
                            if( KDXML::readStringNode( element, string ) )
                                _legendSource = KDChart1Params::stringToLegendSource( string );
                ...
                KDChart1Params::HdFtParams* hfSettings =
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "PrintDataValues" ) {
                            ...
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _printDataValuesSettings._dataValuesAnchorNegativePosition = KDChart1Enums::stringToPositionFlag( value );
                            ...
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _printDataValuesSettings._dataValuesAnchorPositivePosition = KDChart1Enums::stringToPositionFlag( value );
                            ...
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _printDataValuesSettings._dataValuesLayoutPolicy = KDChart1Enums::stringToLayoutPolicy( value );
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "PrintDataValues" ) {
                            ...
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _printDataValuesSettings2._dataValuesAnchorNegativePosition = KDChart1Enums::stringToPositionFlag( value );
                        } else if( tagName == "AnchorNegativeAlign" ) {
                            int value;
                            if( KDXML::readIntNode( element, value ) )
                            ...
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _printDataValuesSettings2._dataValuesAnchorPositivePosition = KDChart1Enums::stringToPositionFlag( value );
                        } else if( tagName == "AnchorPositiveAlign" ) {
                            int value;
                            if( KDXML::readIntNode( element, value ) )
                            ...
                            QString value;
                            if( KDXML::readStringNode( element, value ) )
                                _printDataValuesSettings2._dataValuesLayoutPolicy = KDChart1Enums::stringToLayoutPolicy( value );
                        } else if( tagName == "ShowInfinite" ) {
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "FrameSettings" ) {
                            KDChart1FrameSettings* frameSettings = new KDChart1FrameSettings;
                            uint areaId = KDChart1Enums::AreaUNKNOWN;
                            if( KDChart1FrameSettings::readFrameSettingsNode(
                                        element, *frameSettings, areaId ) ) {
                                QString str;
                                if(areaId == KDChart1Enums::AreaChartDataRegion)
                                    str = QString( "%1/%2/%3/%4" )
                                              .arg( areaId, 5 )
                ...
                while( !node.isNull() ) {
                    ...
                    if( !element.isNull() ) { // was really an element
                        ...
                        if( tagName == "Number" ) {
                            ...
                            KDChart1CustomBox::readCustomBoxNode( element,
                                    customBox );
...
/**
  ...
  */
void KDChart1Params::createColorMapNode( QDomDocument& doc, QDomNode& parent,
        ...
        const QMap< uint, QColor >& map )
{
    ...
    for( QMap<uint,QColor>::ConstIterator it = map.begin();
        ...
        datasetElement.appendChild( datasetContent );
        // Color element
        KDXML::createColorNode( doc, mapElement, "Color", (*it) );
    }
    */
}
...
/**
  ...
  */
void KDChart1Params::createDoubleMapNode( QDomDocument& doc, QDomNode& parent,
        const QString& elementName,
        const QMap< int, double >& map )
{
    ...
    for( QMap<int,double>::ConstIterator it = map.begin();
        ...
        // Color element
        KDXML::createDoubleNode( doc, mapElement, "Factor", (*it) );
    }
    */
}
...
/**
  ...
  */
void KDChart1Params::createChartValueNode( QDomDocument& doc, QDomNode& parent,
        const QString& elementName,
        const QVariant& valY,
        const QVariant& valX,
        const int& propID )
...
/**
  ...
  */
void KDChart1Params::createChartFontNode( QDomDocument& doc, QDomNode& parent,
        const QString& elementName,
...
/**
  ...
  */
bool KDChart1Params::readChartFontNode( const QDomElement& element,
        QFont& font,
        bool& useRelFont,
        int& relFontSize,
        int* minFontSize )
...
/**
  ...
  value and fills a KDChart1Data object with the data.

  \param element the DOM element to read from
  \param value the chart data object to read the data into
  */
bool KDChart1Params::readChartValueNode( const QDomElement& element,
        QVariant& valY,
        QVariant& valX,
        int& propID )
{
...
/**
  ...
  */
QString KDChart1Params::chartTypeToString( ChartType type )
{
    switch( type ) {
        case NoType:
            return "NoType";
...
/**
  ...
  */
KDChart1Params::ChartType KDChart1Params::stringToChartType( const QString& string )
{
    if( string == "NoType" )
        return NoType;
    else if( string == "Bar" )
...
QString KDChart1Params::markerStyleToString( int style )
{
    switch( style ) {
...
QString KDChart1Params::markerStyleToStringTr( int style )
{
    switch( style ) {
        case LineMarkerSquare:
            return tr( "Square" );
...
int KDChart1Params::stringToMarkerStyle( const QString& string )
{
    if( string == "Square" )
...
int KDChart1Params::stringToMarkerStyleTr( const QString& string )
{
    if( string == tr( "Square" ) )
        return LineMarkerSquare;
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::barChartSubTypeToString( BarChartSubType type ) {
    switch( type ) {
        case BarNormal:
            return "BarNormal";
        case BarStacked:
...
/**
  ...
  */
KDChart1Params::BarChartSubType KDChart1Params::stringToBarChartSubType( const QString& string ) {
    if( string == "BarNormal" )
        return BarNormal;
...
/**
  ...
  */
KDChart1Params::LineChartSubType KDChart1Params::stringToLineChartSubType( const QString& string ) {
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::lineChartSubTypeToString( LineChartSubType type ) {
    switch( type ) {
        case LineNormal:
            return "LineNormal";
        case LineStacked:
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::lineMarkerStyleToString( LineMarkerStyle style )
{
...
/**
  ...
  */
QString KDChart1Params::lineMarkerStyleToStringTr( LineMarkerStyle style )
{
...
/**
  ...
  */
KDChart1Params::LineMarkerStyle KDChart1Params::stringToLineMarkerStyle( const QString& string )
{
    return static_cast<KDChart1Params::LineMarkerStyle>(stringToMarkerStyle( string ));
}
...
/**
  ...
  \return the line marker style enum value
  */
KDChart1Params::LineMarkerStyle KDChart1Params::stringToLineMarkerStyleTr( const QString& string )
{
    return static_cast<KDChart1Params::LineMarkerStyle>(stringToMarkerStyleTr( string ));
}
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::areaChartSubTypeToString( AreaChartSubType type ) {
    switch( type ) {
        case AreaNormal:
            return "AreaNormal";
        case AreaStacked:
...
/**
  ...
  */
KDChart1Params::AreaChartSubType KDChart1Params::stringToAreaChartSubType( const QString& string ) {
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::areaLocationToString( AreaLocation type ) {
    switch( type ) {
        case AreaAbove:
            return "Above";
        case AreaBelow:
...
/**
  ...
  */
KDChart1Params::AreaLocation KDChart1Params::stringToAreaLocation( const QString& string ) {
    if( string == "Above" )
        return AreaAbove;
...
/**
  ...
  */
KDChart1Params::PolarChartSubType KDChart1Params::stringToPolarChartSubType( const QString& string ) {
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::polarChartSubTypeToString( PolarChartSubType type ) {
    switch( type ) {
        case PolarNormal:
            return "PolarNormal";
        case LineStacked:
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::polarMarkerStyleToString( PolarMarkerStyle style )
{
    return markerStyleToString( style );
}
...
/**
  ...
  \return the localized string representation of the type enum
  */
QString KDChart1Params::polarMarkerStyleToStringTr( PolarMarkerStyle style )
{
    return markerStyleToStringTr( style );
}
...
/**
  ...
  */
KDChart1Params::PolarMarkerStyle KDChart1Params::stringToPolarMarkerStyle( const QString& string )
{
    return static_cast<KDChart1Params::PolarMarkerStyle>(stringToMarkerStyle( string ));
}
...
/**
  ...
  \return the polar marker style enum value
  */
KDChart1Params::PolarMarkerStyle KDChart1Params::stringToPolarMarkerStyleTr( const QString& string )
{
    return static_cast<KDChart1Params::PolarMarkerStyle>(stringToMarkerStyle( string ));
}
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::hiLoChartSubTypeToString( HiLoChartSubType type ) {
    switch( type ) {
        case HiLoSimple:
            return "HiLoSimple";
        case HiLoClose:
...
/**
  ...
  */
KDChart1Params::HiLoChartSubType KDChart1Params::stringToHiLoChartSubType( const QString& string ) {
...
/**
  ...
  */
KDChart1Params::BWChartSubType KDChart1Params::stringToBWChartSubType( const QString& string ) {
    if( string == "BWSimple" )
        return BWSimple;
    else // should not happen
        return BWNormal;
...
/**
  ...
  */
QString KDChart1Params::bWChartStatValToString( BWStatVal type ) {
    switch( type ) {
...
/**
  ...
  */
KDChart1Params::BWStatVal KDChart1Params::stringToBWChartStatVal( const QString& string ) {
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::legendPositionToString( LegendPosition pos ) {
    switch( pos ) {
        case NoLegend:
            return "NoLegend";
        case LegendTop:
...
/**
  ...
  */
KDChart1Params::LegendPosition KDChart1Params::stringToLegendPosition( const QString& string ) {
    if( string == "NoLegend" )
        return NoLegend;
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::legendSourceToString( LegendSource source ) {
    switch( source ) {
        case LegendManual:
            return "Manual";
...
/**
  ...
  */
KDChart1Params::LegendSource KDChart1Params::stringToLegendSource( const QString& string ) {
    if( string == "Manual" )
        return LegendManual;
...
/**
  ...
  \return the string
  */
QString KDChart1Params::chartSourceModeToString( const SourceMode& mode )
{
    switch( mode ){
    case UnknownMode:
        return "UnknownMode";
...
/**
  ...
  */
KDChart1Params::SourceMode KDChart1Params::stringToChartSourceMode( const QString& string )
{
    if( string.isEmpty() )
        return UnknownMode;
    // compatibility with pre-1.0 KDChart1 stream format:
    bool bOk;
    int mode = string.toInt( &bOk );
    if( bOk && mode >= 0 && mode <= Last_SourceMode )
        return (KDChart1Params::SourceMode)mode;
    // new (KDChart1 1.0...) stream format:
...
/**
  ...
  \return the string representation of the type enum
  */
QString KDChart1Params::bWChartSubTypeToString( BWChartSubType type ) {
    switch( type ) {
        case BWSimple:
            return "BWSimple";
        default: // should not happen
