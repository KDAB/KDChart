...
/**
  \class KDChart1AxisParams KDChart1AxisParams.h
  ...
  \see KDChart1Params.h
  \see KDChart1Params.cpp
...
/**
  \c  enum KDChart1AxisParams::Axistype { AxisTypeUnknown,
  AxisTypeEAST,
  AxisTypeNORTH,
  AxisUP };
  ...
  KDChart1AxesPainter::setAxisAssignment().
  ...
  will be set automatically in KDChart1AxesPainter::setDefaultAxesTypes()
  called by c'tor of class KDChart1AxesPainter

  \sa setAxisType, axisType, KDChart1AxesPainter::setAxisAssignment()
  */
...
/**
  ...
  */
KDChart1AxisParams::KDChart1AxisParams()
{
    ...
    _axisIsoRefAxis = UINT_MAX; // == KDCHART1_NO_AXIS, see KDChart1Params.cpp
    _axisTrueAreaSize = 0;
    ...
    _axisShowGrid      = false;
    _axisGridColor     = KDCHART1_DEFAULT_AXIS_GRID_COLOR;
    _axisGridLineWidth = KDCHART1_AXIS_GRID_AUTO_LINEWIDTH;
    _axisGridStyle     = Qt::SolidLine;

    _axisShowSubDelimiters = true;
    _axisGridSubColor      = KDCHART1_DEFAULT_AXIS_GRID_COLOR;
    _axisGridSubLineWidth  = KDCHART1_AXIS_GRID_AUTO_LINEWIDTH;
    ...
    _axisValueStart        = KDCHART1_AXIS_LABELS_AUTO_LIMIT;
    _axisValueEnd          = KDCHART1_AXIS_LABELS_AUTO_LIMIT;
    _axisValueDelta = KDCHART1_AXIS_LABELS_AUTO_DELTA;
    _axisValueDeltaScale = ValueScaleNumerical;
    _axisValueLeaveOut = KDCHART1_AXIS_LABELS_AUTO_LEAVEOUT;
    ...
    _axisLabelsDateTimeFormat = KDCHART1_AXIS_LABELS_AUTO_DATETIME_FORMAT;
    ...
    _axisDigitsBehindComma = KDCHART1_AXIS_LABELS_AUTO_DIGITS;
...
/**
  ...
  */
void KDChart1AxisParams::setAxisType( AxisType axisType )
{
    _axisType = axisType;
    emit changed();
}
...
/**
  \fn AxisType  KDChart1AxisParams::axisType() const
...
/**
  ...
  \c enum KDChart1AxisParams::AxisPos {  AxisPosSTART = 0,
...
With KDChart1 both ways are possible, see hints given with
...
/**
  ...
  \sa KDChart1Params::setAxisParams, KDChart1Params::axisParams
  */
...
/**
  ...
  */
KDChart1AxisParams::AxisPos KDChart1AxisParams::basicAxisPos( uint pos )
{
    ...
    switch ( pos ) {
        ...
        case AxisPosLowerLeftEdge2:
            ...
            break;
        default: {
                     qDebug( "IMPLEMENTATION ERROR: type missing in KDChart1AxisParams::basicAxisPos()" );
...
/**
  ...
  */
void KDChart1AxisParams::setAxisVisible( bool axisVisible )
{
...
/**
  ...
  */
bool  KDChart1AxisParams::axisVisible() const
{
    return _axisVisible;
}
...
/**
  ...
  \sa setAxisAreaMin, setAxisAreaMax, setAxisArea
  */
void  KDChart1AxisParams::setAxisAreaMode( AxisAreaMode axisAreaMode )
{
...
/**
  ...
  \sa setAxisArea
  */
KDChart1AxisParams::AxisAreaMode  KDChart1AxisParams::axisAreaMode() const
{
...
/**
  ...
  */
QString KDChart1AxisParams::axisAreaModeToString( AxisAreaMode mode ) {
    switch( mode ) {
...
/**
  ...
  */
KDChart1AxisParams::AxisAreaMode KDChart1AxisParams::stringToAxisAreaMode( const QString& type ) {
    if( type == "FixedSize" )
...
\sa setAxisArea
*/
void KDChart1AxisParams::setAxisAreaMin( int axisAreaMin )
{
...
/**
  \fn int  KDChart1AxisParams::axisAreaMin() const
...
See also the examples given with \c KDChart1Params::setAdditionalChartType().
...
*/
void  KDChart1AxisParams::setAxisUseAvailableSpace( int axisUseAvailableSpaceFrom,
...
/**
  \fn  int  KDChart1AxisParams::axisUseAvailableSpaceFrom() const
...
/**
  \fn  int  KDChart1AxisParams::axisUseAvailableSpaceTo() const
...
\sa setAxisArea
*/
void  KDChart1AxisParams::setAxisAreaMax( int axisAreaMax )
{
    _axisAreaMax = axisAreaMax;
    emit changed();
}
/**
  \fn int  KDChart1AxisParams::axisAreaMax() const
...
/**
  ...
  \sa setAxisAreaMode, setAxisAreaMin, setAxisAreaMax
  */
void  KDChart1AxisParams::setAxisArea( AxisAreaMode axisAreaMode,
        int axisAreaMin,
        int axisAreaMax )
{
    _axisAreaMode = axisAreaMode;
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisCalcMode( AxisCalcMode axisCalcMode )
{
...
/**
  \fn  AxisCalcMode  KDChart1AxisParams::axisCalcMode() const
...
/**
  ...
  \return the string representation of the mode enum
  */
QString  KDChart1AxisParams::axisCalcModeToString( AxisCalcMode mode ) {
    switch( mode ) {
        case AxisCalcLinear:
            return "Linear";
...
/**
  ...
  */
KDChart1AxisParams::AxisCalcMode KDChart1AxisParams::stringToAxisCalcMode( const QString& type ) {
    if( type == "Linear" )
...
/**
  ...
  KDChart1 use the same scale for both axes.
  ...
  \verbatim
  KDChart1AxisParams pa(
  _p->axisParams( KDChart1AxisParams::AxisPosBottom ) );
  pa.setIsometricReferenceAxis( KDChart1AxisParams::AxisPosLeft );
  ...
  \note Use special value KDCHART1_ALL_AXES if your chart
  ...
  Use special value KDCHART1_NO_AXIS to undo any previous setting
  ...
  */
void  KDChart1AxisParams::setIsometricReferenceAxis( uint isoRefAxis )
{
...
/**
  \fn uint  KDChart1AxisParams::isometricReferenceAxis() const
  Returns which axis this axis shall be isometric with, this will
  be either the axis position - see KDChart1AxisParams::AxisPos - or one of the special
  values KDCHART1_ALL_AXES and KDCHART1_NO_AXIS.
...
/**
  \fn void  KDChart1AxisParams::setAxisTrueAreaSize( int axisTrueAreaSize )
...
/**
  \fn  int  KDChart1AxisParams::axisTrueAreaSize() const
...
/**
  \fn void  KDChart1AxisParams::setAxisTrueAreaRect( const QRect& axisTrueAreaRect )
...
/**
  \fn  QRect  KDChart1AxisParams::axisTrueAreaRect() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisShowSubDelimiters( bool axisShowSubDelimiters )
{
...
void  KDChart1AxisParams::setAxisShowFractionalValuesDelimiters( bool axisShowFracValDelim )
{
...
/**
  \fn bool  KDChart1AxisParams::axisShowSubDelimiters() const
...
/**
  ...
  \sa axisLineVisible
  */
void  KDChart1AxisParams::setAxisLineVisible( bool axisLineVisible )
{
...
/**
  \fn bool  KDChart1AxisParams::axisLineVisible() const
...
/**
  ...
  \sa axisLineWidth
  */
void  KDChart1AxisParams::setAxisLineWidth( int axisLineWidth )
{
...
/**
  \fn  int  KDChart1AxisParams::axisLineWidth() const
...
/**
  \fn void s KDChart1AxisParams::setAxisTrueLineWidth( int axisTrueLineWidth )
...
/**
  \fn  int  KDChart1AxisParams::axisTrueLineWidth() const
...
/**
  ...
  \sa axisLineColor
  */
void  KDChart1AxisParams::setAxisLineColor( QColor axisLineColor )
{
...
/**
  \fn QColor  KDChart1AxisParams::axisLineColor() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisShowGrid( bool axisShowGrid )
{
...
/**
  \fn bool  KDChart1AxisParams::axisShowGrid() const
...
/**
  ...
  please call \c setAxisGridColor( KDCHART1_DEFAULT_AXIS_GRID_COLOR )

  \param axisGridColor the axis grid color.
  \sa axisGridColor, setAxisShowGrid
  */
void  KDChart1AxisParams::setAxisGridColor( QColor axisGridColor )
{
...
/**
  \fn QColor  KDChart1AxisParams::axisGridColor() const
...
/**
  ...
  To reset the color to the built-in default value
  please call \c setAxisGridSubColor( KDCHART1_DEFAULT_AXIS_GRID_COLOR )
  ...
  */
void  KDChart1AxisParams::setAxisGridSubColor( QColor axisGridSubColor )
{
...
/**
  \fn QColor  KDChart1AxisParams::axisGridSubColor() const
...
You may use setAxisGridLineWidth( KDCHART1_AXIS_GRID_AUTO_LINEWIDTH )
...
\sa setAxisShowGrid, setAxisShowSubDelimiters
*/
void  KDChart1AxisParams::setAxisGridLineWidth( int axisGridLineWidth )
{
...
/**
  \fn int  KDChart1AxisParams::axisGridLineWidth() const
...
/**
  ...
  You may use setAxisGridSubLineWidth( KDCHART1_AXIS_GRID_AUTO_LINEWIDTH )
  to reset the value to its default: being automatically
  adjusted to the width of the axis line.
  ...
  */
void  KDChart1AxisParams::setAxisGridSubLineWidth( int axisGridSubLineWidth )
{
...
/**
  \fn QColor  KDChart1AxisParams::axisGridSubLineWidth() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisGridStyle( Qt::PenStyle axisGridStyle )
{
...
/**
  \fn Qt::PenStyle  KDChart1AxisParams::axisGridStyle() const
...
/**
  ...
  \sa setAxisShowGrid
  */
void  KDChart1AxisParams::setAxisGridSubStyle( Qt::PenStyle axisGridSubStyle )
{
...
/**
  \fn  Qt::PenStyle  KDChart1AxisParams::axisGridSubStyle() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisZeroLineColor( QColor axisZeroLineColor )
{
...
/**
  \fn  QColor  KDChart1AxisParams::axisZeroLineColor() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisLabelsVisible( bool axisLabelsVisible )
{
...
/**
  \fn bool  KDChart1AxisParams::axisLabelsVisible() const
...
/**
  \fn void KDChart1AxisParams::setAxisLabelsFontMinSize( int axisLabelsFontMinSize )
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisLabelsTouchEdges( bool axisLabelsTouchEdges )
{
...
/**
  \fn  bool  KDChart1AxisParams::axisLabelsTouchEdges() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisLabelsFont( QFont axisLabelsFont, bool useFontSize )
{
...
/**
  \fn QFont  KDChart1AxisParams::axisLabelsFont() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisLabelsFontUseRelSize( bool axisLabelsFontUseRelSize )
{
...
/**
  \fn  bool  KDChart1AxisParams::axisLabelsFontUseRelSize() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisLabelsFontRelSize( int axisLabelsFontRelSize )
{
...
/**
  \fn int  KDChart1AxisParams::axisLabelsFontRelSize() const
...
/**
  \fn bool  KDChart1AxisParams::axisLabelsDontShrinkFont() const
...
/**
  \fn  void  KDChart1AxisParams::setAxisLabelsDontAutoRotate( bool labelsDontAutoRotate )
...
/**
  \fn bool  KDChart1AxisParams::axisLabelsDontAutoRotate() const
...
/**
  \fn void  KDChart1AxisParams::setAxisLabelsRotation( int rotation )
...
/**
  \fn  int  KDChart1AxisParams::axisLabelsRotation() const
...
/**
  ...
  \sa axisLabelsColor
  */
void KDChart1AxisParams::setAxisLabelsColor( QColor axisLabelsColor )
{
...
/**
  \fn  QColor  KDChart1AxisParams::axisLabelsColor() const
...
/**
  ...
  */
void KDChart1AxisParams::setAxisLabelsCalc( int divPow10,
...
/**
  ...
  */
void KDChart1AxisParams::setAxisLabelsRadix( const QString& decimalPoint,
...
/**
  ...
  */
void KDChart1AxisParams::setAxisLabelsFormat( const QString& prefix,
...
/**
  ...
  \return the string representation of the mode enum
  */
QString  KDChart1AxisParams::labelsFromDataRowToString( LabelsFromDataRow mode ) {
    switch( mode ) {
...
/**
  ...
  */
KDChart1AxisParams::LabelsFromDataRow  KDChart1AxisParams::stringToLabelsFromDataRow( const QString& type ) {
    if( type == "Yes" )
...
/**
  ...
  \note Start and end values are \c KDChart1Data so you may either
  ...
  KDCHART1_AXIS_LABELS_AUTO_LIMIT as start value (see below).
  <br>
  In case you specify a non-zero integer value for
  \c axisValueDelta the width and direction
  of steps will be performed accordingly:
  ...
  <br>
  (Of course all non-integer values will be ignored here.)
  \li \b or pass <b>KDCHART1_AXIS_LABELS_AUTO_LIMIT</b> as start value
  <br>
  ...
  <br>
  <b>In either case</b> (KDCHART1_AXIS_LABELS_AUTO_LIMIT or numerical value)
...
\verbatim
setAxisValues( true, KDChart1Data( 0.0 ) );
\endverbatim
...
\verbatim
setAxisValues( true, KDChart1Data( -2.0 ),
        KDChart1Data(  7.5 ),
        0.5, 1 );
\endverbatim
...
\verbatim
setAxisValues( false, KDChart1Data( 0.0 ),
        KDChart1Data( 3.5),
        0.25, 2 );
\endverbatim
...
\verbatim
setAxisValues( false,
        KDChart1Data( 1964.0 ), KDCHART1_AXIS_LABELS_AUTO_LIMIT, 1, 0 );
\endverbatim
...
\verbatim
KDChart1Params p;
KDChart1AxisParams pa( p.axisParams( KDChart1AxisParams::AxisPosBottom ) );
...
pa.setAxisValues( false,
        KDChart1Data( "Monday" ),
        KDCHART1_AXIS_LABELS_AUTO_LIMIT,
        KDCHART1_AXIS_LABELS_AUTO_DELTA,
        KDCHART1_AXIS_LABELS_AUTO_DIGITS,
        KDChart1AxisParams::LabelsFromDataRowNo,
        0,
        &abscissaNames,
        &abscissaShortNames );
p.setAxisParams( KDChart1AxisParams::AxisPosBottom, pa );
\endverbatim
...
copied into the \c KDChart1AxisParams nor into the \c KDChart1Params
...
\param axisMaxEmptyInnerSpan specifies the percentage of the y-axis range that may to contain NO data entries, if - and only if - axisValueStart (or axisValueEnd, resp.) is set to KDCHART1_AXIS_LABELS_AUTO_LIMIT. To prevent \c setAxisValues from changing the current setting you may specify KDCHART1_DONT_CHANGE_EMPTY_INNER_SPAN_NOW here, to deactivate taking into account the inner span entirely just use KDCHART1_AXIS_IGNORE_EMPTY_INNER_SPAN.
...
*/
void  KDChart1AxisParams::setAxisValues( bool axisSteadyValueCalc,
        ...
        ValueScale axisValueDeltaScale )
{
    ...
    if ( KDCHART1_DONT_CHANGE_EMPTY_INNER_SPAN_NOW != axisMaxEmptyInnerSpan ) {
        if ( 100 < axisMaxEmptyInnerSpan
                || 1 > axisMaxEmptyInnerSpan )
            _axisMaxEmptyInnerSpan = KDCHART1_AXIS_IGNORE_EMPTY_INNER_SPAN;
        else
...
/**
  \fn  void  KDChart1AxisParams::setAxisValueStart( const KDChart1Data axisValueStart )
...
/**
  \fn  KDChart1Data  KDChart1AxisParams::axisValueStart() const
...
/**
  \fn  void  KDChart1AxisParams::setAxisValueEnd( const KDChart1Data axisValueEnd )
...
/**
  \fn  KDChart1Data  KDChart1AxisParams::axisValueEnd() const
...
/**
  ...
  \sa axisLabelStringList, axisShortLabelsStringList
  */
void  KDChart1AxisParams::setAxisValueDelta( const double axisValueDelta,
        ValueScale scale )
{
    _axisValueDelta = axisValueDelta;
...
/**
  \fn  double KDChart1AxisParams::axisValueDelta() const
...
/**
  \fn ValueScale  KDChart1AxisParams::axisValueDeltaScale() const
...
/**
  \fn  void  KDChart1AxisParams::setAxisValueLeaveOut( const int leaveOut )
  ...
  */
/**
  \fn int  KDChart1AxisParams::axisValueLeaveOut() const
...
/**
  \fn  void  KDChart1AxisParams::setAxisValuesDecreasing( bool valuesDecreasing )
...
/**
  \fn bool  KDChart1AxisParams::axisValuesDecreasing() const
...
/**
  \fn  void  KDChart1AxisParams::setTrueAxisDeltaPixels( double nDeltaPixels )
...
/**
  \fn  double  KDChart1AxisParams::trueAxisDeltaPixels() const
...
/**
  ...
  \sa setAxisArea
  */
void  KDChart1AxisParams::setTrueAxisLowHighDelta( double nLow, double nHigh, double nDelta )
{
    _trueLow = nLow;
    _trueHigh = nHigh;
    _trueDelta = nDelta;
...
/**
  \fn double  KDChart1AxisParams::trueAxisLow() const
...
/**
  \fn  double  KDChart1AxisParams::trueAxisHigh() const
...
/**
  \fn  double  KDChart1AxisParams::trueAxisDelta() const
...
void  KDChart1AxisParams::setTrueAxisDtLowHighDeltaScale( QDateTime dtLow, QDateTime dtHigh,
...
/**
  \fn  void  KDChart1AxisParams::setTrueAxisDtLow( QDateTime dtLow )

*/

/**
  \fn  void  KDChart1AxisParams::void setTrueAxisDtHigh( QDateTime dtHigh )

*/

/**
  \fn  void  KDChart1AxisParams::void setTrueAxisDtScale( ValueScale scale )

*/

/**
  \fn  void  KDChart1AxisParams::QDateTime trueAxisDtLow() const

*/

/**
  \fn  void  KDChart1AxisParams::QDateTime trueAxisDtHigh() const

*/

/**
  \fn  void  KDChart1AxisParams::ValueScale trueAxisDtDeltaScale() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisZeroLineStart( double x, double y )
{
...
/**
  \fn  double  KDChart1AxisParams::axisZeroLineStartX() const
...
/**
  \fn  double  KDChart1AxisParams::axisZeroLineStartY() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisDtLowPos( double x, double y )
{
    _axisDtLowPosX = x;
    _axisDtLowPosY = y;
}
...
/**
  \fn double void  KDChart1AxisParams::axisDtLowPosX() const
  Returns the not-rounded x-position where drawing of
...
/**
  \fn  double  KDChart1AxisParams::axisDtLowPosY() const
  Returns the not-rounded y-position where drawing of
  this axis low date/time value could be done. This function needed
  when painting the data of isometric axes (bars, lines, dots...).
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisDtHighPos( double x, double y )
{
    _axisDtHighPosX = x;
    _axisDtHighPosY = y;
}
...
/**
  \fn  double  KDChart1AxisParams::axisDtHighPosX() const
  Returns the not-rounded x-position where drawing of
...
/**
  \fn  double  KDChart1AxisParams::axisDtHighPosY() const
  Returns the not-rounded y-position where drawing of
  this axis high date/time value could be done. This function needed
  when painting the data of isometric axes (bars, lines, dots...).
...
/**
  \fn void  KDChart1AxisParams::setAxisDigitsBehindComma( const int digits )
...
/**
  \fn  int  KDChart1AxisParams::axisDigitsBehindComma() const
...
/**
  \fn  void  KDChart1AxisParams::setAxisLabelsDateTimeFormat( const QString& format )
  ...
  \c KDCHART1_AXIS_LABELS_AUTO_DATETIME_FORMAT - this is the default setting.
...
/**
  \fn  QString  KDChart1AxisParams::axisLabelsDateTimeFormat() const
...
/**
  \fn  void  KDChart1AxisParams::setAxisMaxEmptyInnerSpan( const int maxEmpty )
  ...
  resp.) is set to KDCHART1_AXIS_LABELS_AUTO_LIMIT.
...
/**
  \fn  int  KDChart1AxisParams::axisMaxEmptyInnerSpan() const
...
/**
  ...
  */
void  KDChart1AxisParams::setLabelTextsFormDataRow( int row, LabelsFromDataRow mode )
{
...
/**
  \fn  void void  KDChart1AxisParams::setLabelTextsFormDataRow( int row, LabelsFromDataRow mode );
...
/**
  \fn  int  KDChart1AxisParams::labelTextsDataRow() const
...
/**
  ...
  KDChart1AxisParams pa( _p->axisParams(
  KDChart1AxisParams::AxisPosBottom ) );
  ...
  \sa KDChart1Params::setAxisLabelStringParams
  \sa axisLabelStringList, axisShortLabelsStringList
  \sa setAxisValues, setLabelTextsFormDataRow
  \sa axisLabelTexts
  */
void  KDChart1AxisParams::setAxisLabelStringLists( QStringList*   axisLabelStringList,
        ...
        const QString& valueEnd )
{
    ...
    if( valueStart.isNull() )
        axisValueStart = KDCHART1_AXIS_LABELS_AUTO_LIMIT;
    else
        axisValueStart = valueStart;

    if( valueEnd.isNull() )
        axisValueEnd = KDCHART1_AXIS_LABELS_AUTO_LIMIT;
    else
    ...
    setAxisValues( false,
            ...
            KDCHART1_AXIS_LABELS_AUTO_LEAVEOUT );

}


/**
  \fn  QStringList  KDChart1AxisParams::axisLabelStringList() const
...
/**
  \fn uint  KDChart1AxisParams::axisLabelStringCount() const
...
/**
  \fn  QStringList  KDChart1AxisParams::axisShortLabelsStringList() const
  Returns a \c QStringList containing the label texts to be used
...
/**
  \fn  uint  KDChart1AxisParamsaxisShortLabelsStringCount() const
  Returns the number of strings stored as label texts,
  the texts can be retrieved by calling \c axisLabelStringList().
...
/**
  \fn  const QStringList*  KDChart1AxisParamsaxisLabelTexts() const
...
/**
  ...
  */
void  KDChart1AxisParams::setAxisLabelTexts( const QStringList* axisLabelTexts )
{
...
/**
  \fn  void  KDChart1AxisParamssetAxisLabelTextsDirty( bool axisLabelTextsDirty )
...
/**
  \fn  bool  KDChart1AxisParams::axisLabelTextsDirty() const
...
/**
  ...
  \sa setAxisLabelStringLists, setLabelTextsFormDataRow, setAxisValues
  */
void  KDChart1AxisParams::setAxisFirstLabelText( const QString& axisFirstLabelText )
{
...
/**
  ...
  \sa setAxisLabelStringLists, setLabelTextsFormDataRow, setAxisValues
  */
void  KDChart1AxisParams::setAxisLastLabelText( const QString& axisLastLabelText )
{
...
/**
  \fn  void  KDChart1AxisParams::setAxisSteadyValueCalc( bool axisSteadyValueCalc )
...
/**
  \fn  bool  KDChart1AxisParams::axisSteadyValueCalc() const
...
/**
  \fn   KDChart1AxisParams::KDChart1AxisParams( const KDChart1AxisParams& R ) : QObject()
...
KDChart1AxisParams& KDChart1AxisParams::operator=( const KDChart1AxisParams& R )
{
    if ( this != &R )
        deepCopy( *this, R );
    return *this;
...
void KDChart1AxisParams::deepCopy( KDChart1AxisParams& D, const KDChart1AxisParams& R )
{
...
/**
  ...
  */
QString  KDChart1AxisParams::axisTypeToString( AxisType type ) {
    switch( type ) {
...
/**
  ...
  */
KDChart1AxisParams::AxisType KDChart1AxisParams::stringToAxisType( const QString& type ) {
    if( type == "Unknown" )
...
/**
  \fn   void  KDChart1AxisParams::changed()
  \c Signals:
...
/**
  \var  KDChart1Data _axisValueStart;
  Specifies the lower limit for the axis labels: the start value.
...
/**
  \var KDChart1Data _axisValueEnd
